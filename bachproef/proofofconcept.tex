...
\begin{listing}
    ...
    \end{minted}
    \caption[AndroidManifest.xml]{Instellingen in het \texttt{AndroidManifest.xml} bestand die de activiteiten en services binnen de applicatie definiëren, waaronder \texttt{ProcessTextActivity} en \texttt{SpeedTestService}.}
